...
- Name: tests\playwright-test.spec.js >> Importar Zonas - Parser Catastro E2E >> Multiple PDFs with duplicate detection
- Location: tests\playwright-test.spec.js:204:3
...
Call log:
  - waiting for locator('#pdf-files') to be visible
