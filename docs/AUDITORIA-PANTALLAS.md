...
| F5 | **Pase visual por pantalla**: textos, encabezados, unidades, capitalización | 🟡 lote 1 ✅ 2026-07-03 (d891ed1): plurales (años/lotes/registros/activos/especies/expediciones/hembras/machos/cabezas), CC.AA./sistema formateados, códigos de evento humanizados, LÁCTICO→LÁCTEO, ºC→°C, versión pie cuaderno→APP_INFO, bugs de datos (censo por sexos H/M; cabezas vivas por rebaño), color de módulo por RUTA (Cuaderno naranja…). **Pendiente lote 2**: unificar Kg/KG→kg (46 usos), decimales es-ES coherentes (informes '5800.0 L', '0.590€', gastos '2340.5 €'), k/K en somáticas, '·' colgante en compradores, trazabilidad sin animal se queda en 'Cargando...', botones 🖨/📎 de documentos → Icons SVG. |
