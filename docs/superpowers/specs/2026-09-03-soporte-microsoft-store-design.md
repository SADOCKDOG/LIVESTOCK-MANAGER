...
`support_unlock` ya está descrito en `livestock-pwa-msix/partner_center_addon.json`, pero como
`MONTHLY`: hay que decidir si se replica el precio anual de Play. El `identifier` de Tauri
