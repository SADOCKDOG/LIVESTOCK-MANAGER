...
| P0-4 | Lazy loading inicial: Convertir script src en script type=module con dynamic import() para vistas no-críticas | 3-4 h | index.html, crear js/bootstrap.js |
