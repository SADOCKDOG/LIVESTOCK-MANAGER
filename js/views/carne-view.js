  ...
  async _abrirOpcionesRegistro(id) {
    try {
      ...
      overlay.innerHTML = `
          <div class="card p-25" style="max-width:420px; overflow-y:auto; max-height:90vh; border: 1px solid var(--c-gray); background: #1e1e1e; width: 100%;">
              ...
              <div class="flex gap-10 mt-20">
                ...
                <button class="wizard-btn-action wizard-btn-secondary mt-10 w-full" onclick="CarneView._cerrarOverlayRegistro(this)">${Icons.cerrar()} Cancelar</button>
            </div>
          </div>`;
      document.body.appendChild(overlay);

      CarneView._registroGuardado = false;
      App.setExitGuard(() => CarneView._confirmSalirOverlayRegistro());
      ...
      overlay.querySelector('#btn-save-reg').onclick = async () => {
        ...
        CarneView._registroGuardado = true;
        App.clearExitGuard();
