...
const CarneView = {
      ...
      <div class="mb-14">
        <div class="scroll-shadow-container" style="margin:0 -12px 10px -12px; padding:0 12px; overflow-x:auto; overflow-y:hidden; -webkit-overflow-scrolling:touch; white-space:nowrap;">
          <div class="carne-tabs" style="display:inline-flex; gap:4px; padding:4px 0;">
            <button class="carne-tab active" data-tab="patrimonio" onclick="CarneView._cambiarTab('patrimonio')">🏰 Patrimonio y Ganadería</button>
            <button class="carne-tab" data-tab="comercializacion" onclick="CarneView._cambiarTab('comercializacion')">🚚 Logística y Transporte, Comercialización Ventas</button>
            <button class="carne-tab" data-tab="legislacion" onclick="CarneView._cambiarTab('legislacion')">🛡️ Registros Legislación, Cumplimiento Sanitario</button>
          </div>
        </div>
      </div>
  ...
  _inyectarEstilos() {
    if (document.getElementById('carne-tab-styles')) return;
    const style = document.createElement('style');
    style.id = 'carne-tab-styles';
    style.textContent = `
      .carne-tabs::-webkit-scrollbar { display: none; }
      .carne-tab {
      ...
      .carne-tab.active { background: #ef4444; color: #fff; border-color: #ef4444; box-shadow: 0 0 14px rgba(239,68,68,0.35); }
      .carne-tab:active { transform: scale(0.95); }
      #carne-content .report-section { max-width:100%; overflow:hidden; }
    ...
    const html = `
      <div class="card report-section p-16 border-top-3px border-top-3px-orange">
        ...
        <div class="text-xs text-gray uppercase font-extrabold tracking-wider border-bottom-222" style="margin-bottom:6px; padding-bottom:5px;">
          📋 Lotes de Carne Activos (${d.rebanosCarne.length})
        </div>
    ...
    const html = `
      <div class="card report-section p-16 border-top-3px" style="border-top-color:#10b981;">
        ...
        <div class="grid grid-cols-3 gap-8 mb-16">
          ...
          <a href="#/transportistas" class="widget-link-btn">🚛 Logística</a>
          <a href="#/comercializacion" class="widget-link-btn">📄 Comercial</a>
        </div>

        <div class="text-xs text-gray uppercase font-extrabold tracking-wider border-bottom-222" style="margin-bottom:6px; padding-bottom:5px;">
          📋 Historial de Facturas/Matadero
        </div>
        <div class="grid gap-10">
    ...
    const html = `
      ...
      <div class="card report-section p-16 border-top-3px" style="border-top-color:#8b5cf6;">
        ...
        <div class="grid grid-cols-2 gap-8 mb-16">
          <a href="#/documentos" class="widget-link-btn">📄 Documentación Oficial</a>
          <a href="#/cuaderno" class="widget-link-btn">🛡️ Cuaderno de Explotación</a>
        </div>

        <div class="text-xs text-gray uppercase font-extrabold tracking-wider border-bottom-222" style="margin-bottom:6px; padding-bottom:5px;">
          📋 Historial Sanitario Cárnico (${d.sanitariosCarne.length})
        </div>
        <div class="grid gap-10">
  ...
  async _abrirAsistenteTratamientoCarne() {
    ...
    overlay.innerHTML = `
      <div class="card p-25" style="max-width:380px; border-top:5px solid #ef4444;">
        <h3 class="mt-0 text-white font-900">💉 Aplicar Tratamiento Cárnico</h3>
