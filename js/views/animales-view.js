        ...
        <div class="flex-1 min-w-0 flex flex-col gap-8">
          <div class="flex items-center gap-10 min-w-0">
            ...
            <div class="text-xs min-w-0">
              <div class="font-bold uppercase text-base tracking-tight text-ellipsis" style="color:var(--p-gold);">${a.numero_identificacion || a.nombre || '#' + a.id} <span class="text-gray-400 ml-4">${iconoSexo}</span></div>
