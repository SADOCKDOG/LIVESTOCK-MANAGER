...
(function () {
  ...
  var ESTILOS = [
    ...
    '.sp-pie-rotulo{font-size:.58rem;letter-spacing:.05em;text-transform:uppercase;color:var(--text-s,#B1B1B1);opacity:1}',
